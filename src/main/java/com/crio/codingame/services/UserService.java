...
public class UserService implements IUserService {
    ...
    //  }
    //  if(userRepository.findByName(userName) == Optional<User>.empty()){
    //     throw new UserNotFoundException();
    //  }

     if(contest.getCreator() == user
     || contest.getContestStatus().equals(ContestStatus.IN_PROGRESS)
     || contest.getContestStatus().equals(ContestStatus.ENDED)
     || !(user.checkIfContestExists(contest))){
        throw new InvalidOperationException("Cannot Withdraw Contest");
     }
